...
CREATE TABLE "reservations" (
	...
	CONSTRAINT "fkClientReserv" NOT NULL FOREIGN KEY ( "idClient" ASC ) REFERENCES "client" ( "id" )
	CONSTRAINT "fkChambreId" FOREIGN KEY ( "idChambre" ASC ) REFERENCES "CHAMBRES" ( "chambreId" )
	CONSTRAINT "AGENTS" FOREIGN KEY ( "IdAgent" ASC ) REFERENCES "AGENTS" ( "IdAgent" );
	ON DELETE CASCADE
	ON UPDATE CASCADE;
...
CREATE TABLE "RESTAURATION" (
	...
	CONSTRAINT "CHAMBRES" FOREIGN KEY ( "chambreId" ASC ) REFERENCES "CHAMBRES" ( "chambreId" )
	ON DELETE CASCADE
	ON UPDATE CASCADE;
